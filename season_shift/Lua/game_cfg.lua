-->game_cfg
cfg_player_acceleration_fast = 0.3
cfg_player_acceleration_low = 0.6
cfg_player_max_v = 1.8
cfg_ice_acceleration_fast = 0.1
cfg_ice_acceleration_low = 0.1
cfg_ice_max_v = 3
cfg_jump_speed = 3
cfg_climb_speed = 1.6
cfg_gravity = 0.3
cfg_mogu_jump = 4
cfg_camera_move_speed = {
  x = 5,
  y = 5,
}
cfg_box_gravity = 0.1
...
cfg_levels_summer = {
  ...
  level4 = 'enemy_catepillersicesongzi1408,2162488,216player_start_pos0,8box1424,1762464,216camera_pos48,16enemy_bees',
